...
//		$wscript .= "var commandArgs = WScript.Arguments.Unnamed;\n\n";
		...
		$wscript .= "for (var i = 0; i < WScript.Arguments.length; i++) {\n";
		$wscript .= "\tvar arg = WScript.Arguments.Item( i );\n";
		$wscript .= "\tif (arg.indexOf('/machine') != 0 && arg.indexOf('/user') != 0 && arg.indexOf('/password') != 0 ) {\n";

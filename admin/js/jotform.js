...
Element.Methods = {
    ...
    wrap: function (element, wrapper, attributes) {
        ...
        else wrapper = new Element('div', wrapper); if (element.parentNode)
...
var JotForm = {
    ...
    setCalendar: function (id) {
        try {
            ...
            $('day_' + id).observe('blur', function () {
                JotForm.calendarClose(calendar);
            });
            $('month_' + id).observe('blur', function () {
                JotForm.calendarClose(calendar);
            });
                    ...
                    if (jQuery(pad).parent().parent().parent().is(":visible")) {
                        ...
                        if (!ret) {
                            if (w.find(".form-line-error").length == 0) {
                                w.append('<div class="form-line-error" style="float:left;">' + '<div class="form-error-message">' + '<img src="http://mustafa.jotform.pro/images/exclamation-octagon.png" align="left" style="margin-right:5px;">' + '<div class="form-error-arrow">' + '<div class="form-error-arrow-inner"></div>' + '</div>' + 'This field is required</div></div>');
                            }
                        } else {
